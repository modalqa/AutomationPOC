...
<body>
    <header>
        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <a class="navbar-brand" href="#">jest-stare</a>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <div class="onoff-switch mr-sm-2 ml-sm-2">
                            <input type="checkbox" name="passoff-switch" class="passoff-switch-checkbox" id="lab-passoff-switch" checked>
                            <label class="onoff-switch-label" for="lab-passoff-switch">
                                <span class="passoff-switch-inner"></span>
                                <span class="passoff-switch-switch"></span>
                            </label>
                        </div>
                    </li>
                    <li class="nav-item">
                        <div class="onoff-switch mr-sm-2 ml-sm-2">
                            <input type="checkbox" name="failoff-switch" class="failoff-switch-checkbox" id="lab-failoff-switch" checked>
                            <label class="onoff-switch-label" for="lab-failoff-switch">
                                <span class="failoff-switch-inner"></span>
                                <span class="failoff-switch-switch"></span>
                            </label>
                        </div>
                    </li>
                </ul>
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="list-group">
                    <p id="test-suites-results" class="list-group-item list-group-item-action">{{results.numPassedTestSuites}} passed, {{results.numTotalTestSuites}} total</p>
                </div>
            </div>
            <!-- /.col-lg-4 -->
            <div class="col-lg-4">
                ...
                <h2>Tests</h2>
                <div class="list-group">
                    <p id="tests-results" class="list-group-item list-group-item-action">{{results.numPassedTests}} passed, {{results.numTotalTests}} total</p>
                </div>
            </div>
            <!-- /.col-lg-4 -->
            <div class="col-lg-4" id="snapshots-group">
                ...
                <h2>Snapshots</h2>
                <div class="list-group">
                    <p id="snapshots-results" class="list-group-item list-group-item-action">{{results.snapshot.matched}} passed, {{results.snapshot.total}} total</p>
                </div>
            </div>
            <!-- /.col-lg-4 -->
        </div>
    ...
    <footer class="footer">
        <div class="container">
            <span class="text-muted">&copy; jest-stare 2019</span>
        </div>
    </footer>
</body>
